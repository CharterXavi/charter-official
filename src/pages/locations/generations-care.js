...
const GenerationsCarePage = ({ data }) => {
  ...
  const pageName = 'Generations Hospice Care';
  let pageLocation = {};
        ...
        <div className="two-column">
          ...
          <div className="content">
            <div className="left">
              ...
              <p>
                Generations Hospice Care is dedicated to providing you or your loved ones with the best
            ...
            <div className="right">
              ...
              <p>
                Generations Hospice Care is a premier provider of a variety of healthcare services including
        ...
        <div className='two-column about-block'>
          ...
          <div className='content'>
              ...
              <div className='right'>   
                <h6>Our Values</h6>
                <p>
                  At Generations, we instill our values into each and every one of our caregivers. We believe
...
export default GenerationsCarePage;
