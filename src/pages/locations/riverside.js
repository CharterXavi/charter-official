...
import aboutImage from '../../images/about-riverside.png'
// import businessImage from '../../images/hiring.png';
import {graphql} from 'gatsby';
import headerImage from '../../images/headers/riverside.png';
...
const RiversidePage = ({ data }) => {
  ...
  const pageName = 'Charter Healthcare of Riverside';
  let pageLocation = {};
  ...
  return (
    <Layout>
      <SEO title="Riverside Home Health, Hospice, & Palliative Care" />
      <div className='location-page'>
        <HeaderStrip2
            image={headerImage}
            title={name}
            headline='The leading home health and hospice care provider in Riverside'
        />

        {/*-------------- TOP TEXT BLOCK -------------- */}
        <div className="two-column">
          <div className="title">
            <h4>Delivering the highest quality healthcare in the Riverside area.</h4>
            <hr/>
          </div>
          <div className="content">
            <div className="left">
              ...
              <p>
                Charter Healthcare of Riverside is dedicated to providing you or your loved ones with the best
            ...
            <div className="right">
              ...
              <p>
                Charter Healthcare of Riverside is a premier provider of a variety of healthcare services including
