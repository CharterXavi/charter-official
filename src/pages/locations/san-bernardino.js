...
import aboutImage from '../../images/about-san-bernardino.png'
// import businessImage from '../../images/hiring.png';
import {graphql} from 'gatsby';
import headerImage from '../../images/headers/san-bernardino.png';

const SanBernardinoPage = ({ data }) => {
  ...
  const pageName = 'Charter Healthcare of San Bernardino';
  let pageLocation = {};
  ...
  return (
    <Layout>
      <SEO title="San Bernardino Home Health, Hospice, & Palliative Care" />
      <div className='location-page'>
        <HeaderStrip2
            image={headerImage}
            title={name}
            headline='The leading home health and hospice care provider in San Bernardino'
        />

        {/*-------------- TOP TEXT BLOCK -------------- */}
        <div className="two-column">
          <div className="title">
            <h4>Delivering the highest quality healthcare in the San Bernardino area.</h4>
            <hr/>
          </div>
          <div className="content">
            <div className="left">
              ...
              <p>
                Charter Healthcare of San Bernardino is dedicated to providing you or your loved ones with the best
            ...
            <div className="right">
              ...
              <p>
                Charter Healthcare of San Bernardino is a premier provider of a variety of healthcare services including
...
export default SanBernardinoPage;
