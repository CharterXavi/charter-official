...
import aboutImage from '../../images/about-simi-valley.png'
...
const HoustonPage = ({ data }) => {
  ...
  const pageName = 'Charter Healthcare of Houston';
  let pageLocation = {};
  ...
  return (
    <Layout>
      <SEO title="Houston Hospice & Home Health" />
        ...
        <div className="two-column">
          ...
          <div className="content">
            <div className="left">
              ...
              <p>
                Charter Healthcare of Houston is dedicated to providing you or your loved ones with the best
            ...
            <div className="right">
              ...
              <p>
                Charter Healthcare of Houston is a premier provider of a variety of healthcare services including
