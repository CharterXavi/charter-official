...
import aboutImage from '../../images/about-orange-county.png'
...
const AlbuqerquePage = ({ data }) => {
  ...
  const pageName = 'Silver Linings Hospice Care';
  let pageLocation = {};
        ...
        <div className="two-column">
          ...
          <div className="content">
            <div className="left">
              ...
              <p>
                Silver Linings Hospice Care is dedicated to providing you or your loved ones with the best
            ...
            <div className="right">
              ...
              <p>
                Silver Linings Hospice Care is a premier provider of a variety of healthcare services including
