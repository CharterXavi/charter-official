...
import aboutImage from '../../images/about-san-diego.png'
// import businessImage from '../../images/hiring.png';
import {graphql} from 'gatsby';
import headerImage from '../../images/headers/san-diego.png';

const SanDiegoPage = ({ data }) => {
  ...
  const pageName = 'Charter Healthcare of San Diego';
  let pageLocation = {};
    ...
    <Layout>
      ...
      <div className='location-page'>
        <HeaderStrip2
            image={headerImage}
            title={name}
            headline='The leading home health and hospice care provider in San Diego'
        />

        {/*-------------- TOP TEXT BLOCK -------------- */}
        <div className="two-column">
          <div className="title">
            <h4>Delivering the highest quality healthcare in the San Diego area.</h4>
            <hr/>
          </div>
          <div className="content">
            <div className="left">
              ...
              <p>
                Charter Healthcare of San Diego is dedicated to providing you or your loved ones with the best
            ...
            <div className="right">
              ...
              <p>
                Charter Healthcare of San Diego is a premier provider of a variety of healthcare services including
