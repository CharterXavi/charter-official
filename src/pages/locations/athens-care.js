...
const AthensCarePage = ({ data }) => {
  ...
  const pageName = 'Genesis Hospice Care';
  let pageLocation = {};
  ...
  return (
    <Layout>
      <SEO title="Athens Hospice Care" />
      <div className='location-page'>
        <HeaderStrip2
            image={headerImage}
            title={name}
            headline='The leading home health and hospice care provider in Athens'
        />

        {/*-------------- TOP TEXT BLOCK -------------- */}
        <div className="two-column">
          <div className="title">
            <h4>Delivering the highest quality healthcare in the Athens area.</h4>
            <hr/>
          </div>
          <div className="content">
            <div className="left">
              ...
              <p>
                Genesis Hospice Care is dedicated to providing you or your loved ones with the best
            ...
            <div className="right">
              ...
              <p>
                Genesis Hospice Care is a premier provider of a variety of healthcare services including
        ...
        <div className='two-column about-block'>
          ...
          <div className='content'>
              ...
              <div className='right'>   
                <h6>Our Values</h6>
                <p>
                  At Genesis, we instill our values into each and every one of our caregivers. We believe
