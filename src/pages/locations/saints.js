...
const SaintsPage = ({ data }) => {
  ...
  return (
    <Layout>
      <SEO title="Saints Hospice, & Palliative Care" />
      <div className='location-page'>
        <HeaderStrip2
            image={headerImage}
            title={name}
            headline='The leading home health and hospice care provider in Plano'
        />

        {/*-------------- TOP TEXT BLOCK -------------- */}
        <div className="two-column">
          <div className="title">
            <h4>Delivering the highest quality healthcare in the Plano area.</h4>
            <hr/>
          </div>
          <div className="content">
            <div className="left">
              ...
              <p>
                Saint's Hospice is dedicated to providing you or your loved ones with the best
            ...
            <div className="right">
              ...
              <p>
                Saint's Hospice is a premier provider of a variety of healthcare services including
