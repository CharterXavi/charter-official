...
import aboutImage from '../../images/about-phoenix.png'
// import businessImage from '../../images/hiring.png';
import {graphql} from 'gatsby';
import headerImage from '../../images/headers/phoenix.png';

const PhoenixPage = ({ data }) => {
  ...
  const pageName = 'Charter Healthcare of Phoenix';
  let pageLocation = {};
  ...
  return (
    <Layout>
      <SEO title="Phoenix Home Health, Hospice, & Palliative Care" />
      <div className='location-page'>
        <HeaderStrip2
            image={headerImage}
            title={name}
            headline='The leading home health and hospice care provider in Phoenix'
        />

        {/*-------------- TOP TEXT BLOCK -------------- */}
        <div className="two-column">
          <div className="title">
            <h4>Delivering the highest quality healthcare in the Phoenix area.</h4>
            <hr/>
          </div>
          <div className="content">
            <div className="left">
              ...
              <p>
                Charter Healthcare of Phoenix is dedicated to providing you or your loved ones with the best
            ...
            <div className="right">
              ...
              <p>
                Charter Healthcare of Phoenix is a premier provider of a variety of healthcare services including
