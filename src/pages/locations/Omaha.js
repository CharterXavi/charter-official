...
import aboutImage from '../../images/about-serene-care.png'
...
const OmahaPage = ({ data }) => {
  ...
  const pageName = 'Charter Hospice of Omaha'; //This is all you need to change for a page to populate itself automatically with location-specific data
  let pageLocation = {};
  ...
  return (
    <Layout>
      <SEO title="Omaha Hospice, & Palliative Care" />
      <div className='location-page'>
        <HeaderStrip2
            image={headerImage}
            title={name}
            headline='The leading hospice care provider in Omaha'
        />
        ...
        <div className="two-column">
          ...
          <div className="content">
            <div className="left">
              ...
              <p>
                Charter Hospice of Omaha is dedicated to providing you or your loved ones with the best
            ...
            <div className="right">
              ...
              <p>
                Charter Hospice of Omaha is a premier provider of a variety of healthcare services including
