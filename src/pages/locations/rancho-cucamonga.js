...
import aboutImage from '../../images/about-rancho-cucamonga.png'
// import businessImage from '../../images/hiring.png';
import {graphql} from 'gatsby';
import headerImage from '../../images/headers/rancho-cucamonga.png';

const RanchoCucamongaPage = ({ data }) => {
  ...
  const pageName = 'Charter Healthcare of Rancho Cucamonga';
  let pageLocation = {};
  ...
  return (
    <Layout>
      <SEO title="Rancho Cucamonga Home Health, Hospice, & Palliative Care" />
      <div className='location-page'>
        <HeaderStrip2
            image={headerImage}
            title={name}
            headline='The leading home health and hospice care provider in Rancho Cucamonga'
        />

        {/*-------------- TOP TEXT BLOCK -------------- */}
        <div className="two-column">
          <div className="title">
            <h4>Delivering the highest quality healthcare in the Rancho Cucamonga area.</h4>
            <hr/>
          </div>
          <div className="content">
            <div className="left">
              ...
              <p>
                Charter Healthcare of Rancho Cucamonga is dedicated to providing you or your loved ones with the best
            ...
            <div className="right">
              ...
              <p>
                Charter Healthcare of Rancho Cucamonga is a premier provider of a variety of healthcare services including
...
export default RanchoCucamongaPage;
