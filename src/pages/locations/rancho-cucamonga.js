...
const RanchoCucamongaPage = ({ data }) => {
  ...
  const pageName = 'Cambridge Hospice of Rancho Cucamonga';
  let pageLocation = {};
        ...
        <div className="two-column">
          ...
          <div className="content">
            <div className="left">
              ...
              <p>
                Cambridge Hospice of Rancho Cucamonga is dedicated to providing you or your loved ones with the best
            ...
            <div className="right">
              ...
              <p>
                Cambridge Hospice of Rancho Cucamonga is a premier provider of a variety of healthcare services including
