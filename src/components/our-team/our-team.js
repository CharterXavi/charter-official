  ...
  return (
    <div className='OurTeamStrip'>
        ...
        <div className='card-container'>
            <div className='card'>
                <Link to='/our-team'>
                    <img src={steve} alt="Team Member" width='230' height='230'/>
                </Link>
            ...
            <div className='card'>
                <Link to='/our-team'>
                    <img src={sabina} alt="Team Member" width='230' height='230'/>
                </Link>
                <div className='card-info'>
            ...
            <div className='card'>
                <Link to='/our-team'>
                    <img src={vince} alt="Team Member" width='230' height='230'/>
                </Link>
                <div className='card-info'>
            ...
            <div className='card'>
                <Link to='/our-team'>
                    <img src={jeanclaude} alt="Team Member" width='230' height='230'/>
                </Link>
                <div className='card-info'>
            ...
            <div className='card'>
                <Link to='/our-team'>
                    <img src={sylvie} alt="Team Member" width='230' height='230'/>
                </Link>
                <div className='card-info'>
                    <h6>Sylvie Boal</h6>
            ...
            <div className='card'>
                <Link to='/our-team'>
                    <img src={meagan} alt="Team Member" width='230' height='230'/>
                </Link>
                <div className='card-info'>
