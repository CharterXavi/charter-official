      ...
      <div className='header-boundary'>
        <div className={`main-bar ${isMenuExpanded ? 'background-blur' : ''}`}>
          ...
          <div className='header-right'>
            ...
            {isMenuExpanded ? 
              <small style={{color: 'white', margin: '0 0 0 28.5px'}}>CLOSE</small> /* margin included since 'close' is longer word than 'menu', causing neighboring elements to move around */
              :
