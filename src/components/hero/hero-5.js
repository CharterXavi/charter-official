...
import doctorGraphic from '../../images/doctor-svg-2.png';
    ...
    return (
        <div className='Hero5'>
            <div className='hero-wrapper'>
                ...
                <svg className='hero-wave-right' xmlns="http://www.w3.org/2000/svg" width="442" height="662" viewBox="0 0 442 662" fill="none">
                    <g filter="url(#filter21_d)">
                    <path d="M442 6C442 6 244 38 265 172C286 306 126.5 365.5 126.5 497C126.5 628.5 11 656 11 656H442V6Z" fill="#F6F7FB"/>
                    </g>
                    <defs>
                    <filter id="filter21_d" x="0" y="0" width="443" height="662" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
